  ...
  return (
    <section className="landing-section">
      <header className="landing-section__head">
        ...
        <Link to="/leaderboard" className="landing-section__cta">
          Full leaderboard <ArrowIcon direction="right" />
        </Link>
      </header>
        ...
        <NavScroller scrollClassName="landing-shelf-h__scroll landing-players-strip">
          {entries.map((p) => {
            ...
            return (
              ...
              >
                <span
                  className={`landing-player-card__rank ${isTop ? "top" : ""}`}
                >
                  #{p.rank}
                </span>
                ...
                <span className="landing-player-card__name">
                  <ColoredText
                    text={
                      p.player.is_vr
                        ? stripVRPrefix(p.player.name)
                        : p.player.name
                    }
                  />
                </span>
                <span className="landing-player-card__stat">{p.victories}</span>
                <span className="landing-player-card__stat-label">
                  victories
                </span>
              </Link>
            );
