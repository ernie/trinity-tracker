...
const DOCS_ITEMS = [
  ...
  { path: '/docs/install', label: 'Install', hint: 'Download · assets · updates' },
  { path: '/docs/install#install-trinity', label: 'Install Trinity' },
  { path: '/docs/install#automatic-updates', label: 'Automatic updates' },
  ...
  { path: '/docs/server-admin', label: 'Server admin', hint: 'Hub setup' },
