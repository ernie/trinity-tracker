...
// Extracted from PageNav as part of the community cluster: Download
// belongs with the other external/social affordances (Discord, GitHub)
// rather than mixed in with primary nav links.
