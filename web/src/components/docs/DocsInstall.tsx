    ...
    <>
          ...
          <PlatformTabs.Panel platform="flatscreen">
            ...
            {detectedOS && (
              ...
              >
                ...
                {flatscreen?.version ? ` ${flatscreen.version}` : ''}
                {' '}for {FLATSCREEN_DOWNLOADS[detectedOS].label} →
              </a>
            )}
            <p className="install-download-others">
              {detectedOS ? 'Need a different platform? ' : 'Pick the build for your platform: '}
              <a
                href={flatscreen?.url ?? 'https://github.com/ernie/trinity-engine/releases/latest'}
                target="_blank"
      ...
      <div className="about-section">
        ...
        <p>
          ...
          legitimate copy of Quake 3 Arena (which includes the Team
          Arena mission pack) to play. The base <code>pak0.pk3</code>{' '}
          files contain the original game assets and aren't
          redistributable, so you bring your own:
        </p>
        <ul>
          <li>
            Buy{' '}
            ...
            {' '}(or use a retail CD install). Steam's release ships
            both the base game and Team Arena.
          </li>
          <li>
            Find your Quake 3 install folder. In Steam, right-click
            the game in your library →{' '}
            <strong>Manage</strong> →{' '}
            <strong>Browse local files</strong> to open it in your
            file manager.
          </li>
          <li>
            Copy <code>baseq3/pak0.pk3</code> into your install's{' '}
            <code>baseq3</code> folder (this is the base Quake 3
            content).
          </li>
          <li>
            Copy <code>missionpack/pak0.pk3</code> into your
            install's <code>missionpack</code> folder (this is the
            Team Arena content — needed if you want to play Team
            Arena modes).
          </li>
        </ul>
        <PlatformNote platform="quest">
          <p>
            ...
            <code>/sdcard/ioquake3Quest/baseq3/</code> and{' '}
            <code>/sdcard/ioquake3Quest/missionpack/</code> on the
            headset's internal storage. The engine creates these
            directories on first launch. Use SideQuest's file
            browser to copy each <code>pak0.pk3</code> into the
            matching folder.
          </p>
        </PlatformNote>
        {detectedOS === 'macos' && (
      ...
      <div className="about-section">
        ...
        <p>
          ...
          <strong>required patches for both Quake III Arena and Team
          Arena</strong>.
        </p>
        <p>
        ...
        <p>
          Copy each folder's files into the matching folder in your
          install — <code>baseq3</code> files into{' '}
          <code>baseq3</code>, <code>missionpack</code> files into{' '}
          <code>missionpack</code>.
        </p>
      ...
      <div className="about-section">
        ...
        <PlatformOnly platform={['flatscreen', 'pcvr']}>
          <p>
            Trinity checks for new releases on startup. When an
            update is available, an indicator appears on the main
            menu — download and apply it from there. The engine
            handles the relaunch automatically.
          </p>
        </PlatformOnly>
        <PlatformOnly platform="quest">
          <p>
            Trinity checks for new releases on startup. When an
            update is available, an indicator appears on the main
            menu — download and apply it from there. After Android
            finishes installing the new APK, relaunch Trinity from
            the headset's app library.
          </p>
        </PlatformOnly>
      </div>
        ...
        <div className="install-troubleshooting">
          <PlatformOnly platform="flatscreen">
            <details className="install-trouble">
              ...
              <div className="install-trouble__body">
                <p>
                  Trinity needs <code>pak0.pk3</code> from a
                  legitimate Quake 3 install. If it's missing or
                  corrupt, Trinity quits with a fatal-error dialog
                  ending in <em>"you need to install Quake III
                  Arena in order to play"</em>; the console (or
                  log) spells out the cause — look for{' '}
                  <em>"pak0.pk3 is missing"</em> or{' '}
                  <em>"Point Release files are missing"</em>.
                </p>
                <p>
                  Re-check Step 2 (and Step 3 for the
                  point-release patches). <code>pak0.pk3</code>{' '}
                  should sit in your install's <code>baseq3</code>{' '}
                  folder, and <code>missionpack/pak0.pk3</code>{' '}
                  too if you want Team Arena. On case-sensitive
                  filesystems the filename has to be lowercase
                  exactly.
                </p>
              </div>
            </details>
          ...
          <PlatformOnly platform="pcvr">
            <details className="install-trouble">
              ...
              <div className="install-trouble__body">
                <p>
                  Trinity needs <code>pak0.pk3</code> from a
                  legitimate Quake 3 install. If files are
                  missing, Trinity quits with a fatal error like{' '}
                  <em>"Quake 3 data files are missing. Please
                  copy …"</em> followed by a list of the specific
                  paks it couldn't find. Team Arena content
                  surfaces the same way —{' '}
                  <em>"Quake 3 Team Arena data files are
                  missing"</em>.
                </p>
                <p>
                  Re-check Step 2 (and Step 3 for the
          ...
          <PlatformOnly platform="quest">
            <details className="install-trouble">
              ...
              <div className="install-trouble__body">
                <p>
                  Trinity needs <code>pak0.pk3</code> from a
                  legitimate Quake 3 install. If it's missing,
                  Trinity quits with a fatal error including{' '}
                  <em>"pak0.pk3" is missing. Please copy it from
                  your legitimate Q3 CDROM.</em> If the patches
                  are missing too, you'll also see{' '}
                  <em>"Point Release files are missing. Please
                  re-install the 1.32 point release."</em>
                </p>
                <p>
                  Re-check Step 2 (and Step 3 for the
                  point-release patches). <code>pak0.pk3</code>{' '}
                  should sit in{' '}
                  <code>/sdcard/ioquake3Quest/baseq3/</code> on
                  the headset, and{' '}
                  <code>/sdcard/ioquake3Quest/missionpack/pak0.pk3</code>{' '}
                  too if you want Team Arena.
                </p>
              </div>
            </details>
          </PlatformOnly>
          ...
          <PlatformOnly platform="quest">
            <details className="install-trouble">
              ...
              <div className="install-trouble__body">
                <p>
                  The most common cause of this is the older Team
                  Beef release being on your headset. The updated
                  version is signed by a different author and can't
                  install over top of the Team Beef release.
                  Uninstall the Team Beef Quake3Quest through Quest's
                  app library, then install Trinity's build. While
                  you're at it, clear any <code>autoexec.cfg</code>{' '}
                  and <code>q3config.cfg</code> files from{' '}
                  <code>/sdcard/ioquake3Quest/baseq3/</code> and{' '}
                  <code>/sdcard/ioquake3Quest/missionpack/</code> so
                  Trinity starts with fresh settings.
                </p>
          ...
          <details className="install-trouble">
            <summary>Update isn't being detected, or you're stuck on an older version</summary>
            <div className="install-trouble__body">
              <p>
                If you aren't receiving updates, you can force a
                re-check from the in-game console:
              </p>
              <ol>
                <li>
                  Open the console.{' '}
                  ...
                  <PlatformOnly platform={['pcvr', 'quest']}>
                    In VR, open it from the in-game menu — there's
                    no keyboard <code>~</code> binding in VR.
                  </PlatformOnly>
                </li>
                <li>
                  Run <code>update_force 1</code> — this bypasses the
                  version comparison so the engine treats the latest
                  release as available even if your version looks
                  current.
                </li>
                <li>
                  Run <code>update</code> — kicks off a fresh check
                  against GitHub. When it finishes, the main menu's
                  update indicator lights up.
                </li>
                <li>Apply from the menu as usual.</li>
              </ol>
              <p>
                <code>update_force</code> is session-only — it resets
                next launch, so you don't need to clear it.
              </p>
            </div>
          </details>
          ...
          <details className="install-trouble">
            ...
            <div className="install-trouble__body">
              <p>
                Stats only flow from servers that run the Trinity
                collector. Trinity is backwards-compatible with
                vanilla servers, but vanilla servers don't report
                matches anywhere. Check the server cards on the{' '}
                <Link to="/servers">Servers page</Link> —
                collector-enabled servers are labeled.
              </p>
              <p>
                You don't need a Trinity account for the hub to
                track you — accounts come into play if your stats
                end up split across multiple installs (next item).
              </p>
            </div>
          </details>

          <details className="install-trouble">
            <summary>My stats look too low / I see more than one player with my name</summary>
            <div className="install-trouble__body">
              <p>
                Trinity identifies you by a per-install file (your{' '}
                <code>qkey</code>), so each Trinity install starts
                out as a separate identity from the hub's
                perspective. If you've installed on more than one
                machine — or reinstalled — your stats can end up
                split across two or three "yous," even if the
                in-game name is the same.
              </p>
              <p>
                Sign into a Trinity account on every platform you
                play on, and the hub merges your installs
                automatically — no manual <code>!link</code>{' '}
                commands needed. See the{' '}
                <Link to="/docs/account">Account docs</Link> for
                the sign-in flow.
              </p>
            </div>
          </details>
          ...
          <details className="install-trouble">
            ...
            <div className="install-trouble__body">
              ...
              <ul>
                <li>
                  <strong>Are you receiving voice at all?</strong>{' '}
                  When someone speaks, a speaker icon shows up over
                  their head and in the talker stack at the upper
                  right of the HUD. If those never appear, you're
                  not getting voice from the server.
                </li>
                <li>
                  <strong>Voice volume.</strong> The game has a
                  separate voice-chat volume from main and music
                  volume — find the voice slider in the in-game
                  audio settings. If your other volumes are loud,
                  voice can be drowned out without you realizing
                  it's just turned down.
                </li>
                <li>
                  <strong>Client setting.</strong>{' '}
                  <code>cl_voip 1</code> must be set in your config
                  (it's the default, so this is usually fine).
                </li>
                <li>
                  <strong>Server setting.</strong> If the indicators
                  never appear no matter who's playing, the server
                  probably doesn't have voice chat turned on. Try a
                  different server, or ask in the{' '}
          ...
          <details className="install-trouble">
            ...
            <div className="install-trouble__body">
              <p>
                Look at the speaker icon on your own player portrait
                in the HUD — that's the fastest way to read your
                transmit state:
              </p>
              <ul>
                <li>
                  <strong>Speaker with an X next to it.</strong>{' '}
                  You're self-muted. Unmute and try again.
                </li>
                <li>
                  <strong>Speaker with no sound waves.</strong> Your
                  mic is on but you're not currently transmitting.
                  Depending on your voice settings, you may need to
                  press a bound input — push-to-talk requires
                  holding a key while you speak; voice-activity mode
                  transmits automatically when it picks up sound.
                </li>
                <li>
                  <strong>Speaker with sound waves.</strong> You're
                  transmitting. If people still can't hear you, the
                  issue is downstream — server config or their end.
                  Hop into the{' '}
                  <a href={DISCORD_INVITE_URL}>Trinity Discord</a>{' '}
                  for help digging in.
                </li>
