...
export function LazyVideo({ webm, mp4, minHeight = 240, className }: LazyVideoProps) {
  ...
  return (
    <div ref={ref} className={className} style={!visible ? { minHeight: `${placeholderHeight}px` } : undefined}>
      {visible && (
