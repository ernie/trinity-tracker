          ...
          {sessions.map((session) => (
            <tr key={session.id}>
              <td data-label="Server">
                {session.server_source} / {session.server_key}
              </td>
              ...
              <td data-label="Engine" className="client-engine">
                {session.client_engine || "-"}
              </td>
              <td data-label="Trinity" className="client-version">
