...
export const ACTIVITY_FILTER_DEFAULT_ON: ReadonlySet<ActivityFilterKey> =
  new Set(["join", "leave", "match_start", "flag_capture", "obelisk_destroy"]);
...
export function classifyActivity(
  ...
  switch (a.activityType) {
    ...
    case "obelisk_destroy":
      return "obelisk_destroy";
    case "obelisk_damage":
      return "obelisk_damage";
    case "skull_score":
      return "skull_score";
    case "skull_pickup":
      return "skull_pickup";
    ...
    case "award":
      switch (a.awardType) {
        case "impressive":
          return "award_impressive";
        case "excellent":
          return "award_excellent";
        case "humiliation":
          return "award_humiliation";
        case "defend":
          return "award_defend";
        case "assist":
          return "award_assist";
