...
export const VR_CVARS: CvarEntry[] = [
  ...
  },
  {
    ...
    default: '1',
    platforms: VR_PLATFORMS,
    description: 'Strafe direction reference when moving.',
    values: [
  ...
  },
  {
    ...
    default: '0.5',
    platforms: VR_PLATFORMS,
    description: 'Controller vibration / haptic feedback intensity, 0.0 to 1.0.',
  },
  {
    name: 'vr_hudDepth',
    default: '3',
  ...
  },
  {
    ...
    default: '0.15',
    platforms: VR_PLATFORMS,
    description: 'Thumbstick dead-zone threshold (input below this is treated as zero).',
  },
  {
    name: 'vr_thumbstickFullDeflection',
    default: '0.85',
    platforms: VR_PLATFORMS,
    description: 'Thumbstick full-deflection threshold (input above this is treated as max).',
  },
  {
  ...
  },
  {
    ...
    values: [
      ...
      { value: '1', meaning: 'basic — weapon aims along a line from your weapon hand toward your off-hand position' },
      { value: '2', meaning: 'virtual gun stock — weapon anchors near your face, like sighting along a stock' },
    ],
  },
  {
    name: 'vr_uturn',
    default: '0',
    platforms: VR_PLATFORMS,
    description: 'Enable a 180° U-turn snap (typically bound to a controller button).',
  },
  {
    name: 'vr_weaponScope',
    default: '1',
...
export const SERVER_CVARS: CvarEntry[] = [
  ...
  },
  {
    ...
    default: '0',
    platforms: ALL_PLATFORMS,
    description: 'Movement physics profile (acceleration, air control, friction).',
    values: [
      { value: '0', meaning: 'Quake 3' },
      { value: '1', meaning: 'CPMA' },
      { value: '2', meaning: 'Quake Live' },
  ...
  },
  {
    ...
    default: '0',
    platforms: ALL_PLATFORMS,
    description: 'Path to a map rotation file for automated map cycling. Empty / 0 disables rotation.',
  },
  {
  ...
  },
  {
    ...
    notes: 'Required (= 1) for the server to participate in the Trinity network.',
  },
  {
    name: 'sv_dlRate',
    default: '100',
