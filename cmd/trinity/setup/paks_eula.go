...
// downloads from files.ioquake3.org.
//
// Reproduced verbatim. Do not paraphrase or "clean up" the wording —
// it's a binding legal document, and the capitalization quirks
// (Id Software, all-caps clauses, etc.) are part of the original.
const quake3EULA = `LIMITED USE SOFTWARE LICENSE AGREEMENT
...
any of the following acts:
  ...
  g.  disassemble, reverse engineer, decompile, modify or alter the
      Software including, without limitation, creating or developing
      extra or add-on levels for the Software;
  ...
  l.  remove or alter any legal notices or other markings or
      legends, such as trademark and copyright notices, affixed on or
      within the Software.
